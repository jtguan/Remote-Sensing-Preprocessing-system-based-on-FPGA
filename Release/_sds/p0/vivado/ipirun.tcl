...
set dsa_name "zcu102"
set dsa_part "xczu9eg-ffvb1156-2-e"
set output_dir "output"
set steps_log "D:/ljd4/GCRU/Release/_sds/p0/p0.steps.log"
set vivado_error_file "vivado_error.txt"
set vivado_warn_file "vivado_warning.txt"
set kernel_ip_dirs {
  {D:/ljd4/GCRU/Release/_sds/iprepo/repo}
  {C:/Xilinx/SDx/2018.3/data/ip/xilinx}}
set install_ip_cache "C:/Xilinx/SDx/2018.3/data/cache/xilinx"
...
# kernel clock 'PL 6' (6)
set dict_clk_wiz_0_clk_out7 [dict create \
  is_user_set false \
  clk_id 6 \
  freq 599.940000 \
];
...
set kernel_clock_freqs [dict create \
  ...
  clk_wiz_0_clk_out7 $dict_clk_wiz_0_clk_out7 \
];
...
set dsa_info [dict create \
  dsa_part                 "xczu9eg-ffvb1156-2-e" \
  dsa_vbnv                 "xilinx.com:zcu102:zcu102:1.0" \
  dsa_dcp                  "" \
  bb_locked_dcp            "" \
  dsa_uses_pr               false \
  ...
  dsa_bconn_locked          {} \
  dsa_bconn_unlocked        {} \
  dsa_board_part           "xilinx.com:zcu102:part0:3.2" \
  link_output_format        bitstream \
  is_unified                true \
  dsa_dcp_top              "zcu102_wrapper" \
  xpfm_file                "C:/Xilinx/SDx/2018.3/platforms/zcu102/zcu102.xpfm" \
];
...
set config_info [dict create \
  ...
  no_ip_cache               false \
  remote_ip_cache          "D:/ljd4/ip_cache" \
  user_board_repo           {} \
  user_bconn                {} \
